...
namespace Shop
{
    public class YokaiStore : ShopBase, Itrade
    {
        ...
        {
            if (GameManager.Instance.IsPlayerMoveLocked(PlayerLockSources.YokaiStore))
            {
                _shopUIView.SetVisible();
                GameManager.Instance.UnlockPlayerMove(PlayerLockSources.YokaiStore);
                return;
            }
            ...
            _shopUIView.SetVisible();
            GameManager.Instance.LockPlayerMove(PlayerLockSources.YokaiStore);
        }
