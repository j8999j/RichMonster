...
namespace Shop
{
    public class HumanShopEat : ShopBase, Itrade
    {
        void OnEnable()
        {
        ...
        {
            if (GameManager.Instance.IsPlayerMoveLocked(PlayerLockSources.HumanShopEat))
            {
                _shopUIView.SetVisible();
                GameManager.Instance.UnlockPlayerMove(PlayerLockSources.HumanShopEat);
                return;
            }
            ...
            _shopUIView.SetVisible();
            GameManager.Instance.LockPlayerMove(PlayerLockSources.HumanShopEat);
        }
