...
namespace Souvenir
{
    ...
    /// </summary>
    [SouvenirDefinition("Sou_GhostTribute")]
    public class Sou_GhostTribute : SpecialSouvenir, IMonsterTradeWithRaceListener, ISpecialSouvenirSave, ISouvenirInteractive
    {
        ...
        public override string DisplayName => "幽靈的餽贈";
        public override string DisplayCondition => "累計讓幽靈客人滿意 50 次";
        public override string DisplayDescription => "來自幽靈部落的感謝，見證了你的交易手腕。";
        ...
        /// <summary> 累計使幽靈客人滿意的次數 </summary>
        public int SatisfiedCount { get; set; }

        private const int RequiredCount = 50;
        private const string TargetRace = "幽靈";
        ...
        public Sou_GhostTribute() : base()
        {
            EffectName = "將引導你看見原本不可見之事物";
        }

        /// <summary> 從存檔中恢復進度 </summary>
        public void Initialize()
        {
            var saved = DataManager.Instance.GetSpecialSouvenirSaveData(SouvenirID) as Sou_GhostTribute;
            if (saved != null)
            {
